            ...
            try:
                while True:
                    ...
                    while True: #This loop represents the single match
                        ...
                        AI_Test_Move = AI_Player.makeMove(board)
                        ...
                        if (board.put("x",AI_Test_Move)):
                            ...
                            AI_Player.mutateWeight(tempKnowledge, 0)
                        ...
                        if (roundCount < 9):
                            ...
                            print ("Draw!")
                            draws += 1
                            AI_Player.mutateWeight(tempKnowledge, 2)
                            printMatchStats(timeStart, iterationCounter, wins, losses, draws)
                            break
                    print ("")

            except KeyboardInterrupt:
                #This is the solution i found that allows the user to stop the code whilst it is running
                print("Loop stopped")
                printMatchStats(timeStart, iterationCounter, wins, losses, draws)

        elif menuOption == "1":
            print("\nThis is the complete knowledge base of AI_test")
            AI_Player.displayKnowledge()

        elif menuOption == "2":
            print("Enter a board state in the format 000000000, use x, o or 0")
            inputState = input("Enter a state\n")
            AI_Player.getKnowledge(inputState)
